...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_exp = 10,                       /* exp  */
  YYSYMBOL_exp_entera = 11                 /* exp_entera  */
};
...
#line 1135 "y.tab.c"
  ...
  case 6: /* exp: exp_entera  */
#line 29 "bison.y"
                   {printf("%lf\n", (yyvsp[0].real));printf(">");}
#line 1141 "y.tab.c"
    break;

  case 7: /* exp_entera: ENTERO  */
#line 32 "bison.y"
                       { (yyval.real) = (yyvsp[0].entero); }
#line 1147 "y.tab.c"
    break;

  case 8: /* exp_entera: IDENTIFICADOR  */
#line 33 "bison.y"
                               {
                                if(buscarNodoTabla((yyvsp[0].identificador))){
                                        (yyval.real) = devolverNodoTabla((yyvsp[0].identificador));
                                }
                                else{
...
#line 1160 "y.tab.c"
  ...
  case 9: /* exp_entera: exp_entera '+' exp_entera  */
#line 41 "bison.y"
